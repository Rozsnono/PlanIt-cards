                    ...
                    data && data.map((game: any, index: number) => (
                        <React.Fragment key={game._id}>
                            <tr className="hover:bg-zinc-800 duration-200 transition-all">
                                ...
                                <td className="p-2">
                                    <div onClick={() => { router.push('/admin/games/' + game.game_id._id) }} className="text-zinc-200 p-2 px-4 rounded-md bg-zinc-900 hover:bg-blue-800 focus:bg-zinc-800 flex justify-center items-center gap-1 cursor-pointer duration-200 transition-all">
