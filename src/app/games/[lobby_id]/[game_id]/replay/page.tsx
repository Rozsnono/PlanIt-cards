                                ...
                                <div key={j} className="w-16 h-16 relative group cursor-pointer">
                                    {
                                        user.name.split(' ').length > 1 ?
                                            <div style={{ color: getColorByInitials(getUserInitialsByName(user.name)).text, backgroundColor: getColorByInitials(getUserInitialsByName(user.name)).background }} className="w-16 h-16 rounded-full flex text-zinc-300 items-center justify-center">
