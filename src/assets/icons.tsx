...
function getIcon(name: string) {
    switch (name) {
        ...
        case "palette": {
            return (
                <>
                    ...
                    <path d="M6.5 13a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
                    <path d="M9.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
                    <path d="M14.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
                    <path d="M17.5 13a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
                </>
            )
        }
        ...
        case "bell": {
            return (
                <>
                    <path d="M15.5 7h-7a6.5 6.5 0 0 0 0 13h7a6.5 6.5 0 1 0 0-13Z"></path>
                    <path d="M12 20c2.21 0 4-2.91 4-6.5S14.21 7 12 7s-4 2.91-4 6.5S9.79 20 12 20Z"></path>
                    <path d="M15 3h-1.5A1.5 1.5 0 0 0 12 4.5V7"></path>
                </>
            )
        }
        case "acorn": {
            return (
                <>
                    <path d="M 6 9 c 0 -2.21 1.79 -4 6 -4 s 6 2 6 4 c 0 1 -0.5 2 -1 2.5 H 7 c -0.5 -0.5 -1 -1.5 -1 -2.5 z"></path>
                    <path d="M 7 12.5 c 0 0 0 6 5 6 s 5 -4.5 5 -6"></path>
                    <path d="M12 2.4v1.5"></path>
                </>
            )
        }
        ...
        case "wifi-full": {
            return (
                <>
                    <path fillRule="evenodd" d="M12 4.727c-3.95 0-7.776 1.9-10.621 5.35L.22 9.123C3.316 5.37 7.55 3.227 12 3.227s8.683 2.144 11.779 5.896l-1.158.954c-2.845-3.45-6.67-5.35-10.621-5.35Zm0 6.674c-2.55 0-5.032 1.227-6.888 3.476l-1.157-.954C6.06 11.37 8.949 9.9 12 9.9s5.94 1.47 8.045 4.022l-1.157.954C17.032 12.627 14.55 11.4 12 11.4Zm-2.35 7a2.35 2.35 0 1 1 4.7 0 2.35 2.35 0 0 1-4.7 0Zm2.35-.85a.85.85 0 1 0 0 1.7.85.85 0 0 0 0-1.7Z" clipRule="evenodd"></path>
                </>
            )
        }
        case "wifi-low": {
            return (
                <>
                    <path d="M5.15 14.91c1.848-2.24 4.317-3.46 6.85-3.46 2.533 0 5.002 1.219 6.85 3.458l1.234-1.018C17.97 11.328 15.068 9.85 12 9.85c-3.068 0-5.97 1.478-8.084 4.04l1.234 1.018Z"></path>
                    <path d="M9.6 18.4a2.4 2.4 0 1 1 4.8 0 2.4 2.4 0 0 1-4.8 0Z"></path>
                </>
            )
        }
        case "wifi-none": {
            return (
                <>
                    <path d="M12 16a2.4 2.4 0 1 0 0 4.8 2.4 2.4 0 0 0 0-4.8Z"></path>
                </>
            )
        }
        ...
        case "wifi-off": {
            return (
                <>
                    ...
                    <path d="M9.172 15.171a4 4 0 0 1 5.656 0"></path>
                    <path d="M14.37 10.358a7.967 7.967 0 0 1 3.287 2"></path>
                    <path d="M6.343 12.343a7.963 7.963 0 0 1 3.864-2.14"></path>
                    <path d="M10.16 6.142a12 12 0 0 1 10.325 3.374"></path>
                    <path d="M3.515 9.517a12 12 0 0 1 3.544-2.455"></path>
        ...
        case "draw": {
            return (
                <>
                    <path d="M9 7v3"></path>
                    <path d="M17 13V5a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h7"></path>
                    <path d="M21 22v-7.1a7 7 0 0 0-2.052-4.95L16.998 8v6.587c0 .89-1.077 1.337-1.707.707L13.996 14c-.5-.5-1.701-.8-2.502 0-.8.8-.5 2 0 2.5l5.503 5.5"></path>
                    <path d="M13 3v10.5"></path>
                </>
            )
        }
